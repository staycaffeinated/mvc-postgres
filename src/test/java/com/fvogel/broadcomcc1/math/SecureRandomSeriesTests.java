...
class SecureRandomSeriesTests {
	...
	/**
	 * Exercise the nextLong() method. Under the covers, a SecureRandom is used, so
	 * its presumed the SecureRandom has been verified by the JRE implementors to
	 * ensure randomness. This test verifies the SecureRandomSeries wrapper around
	 * the SecureRandom is working.
	 */
	@Test
