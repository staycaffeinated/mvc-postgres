...
/**
 * This is a constraint for alphabet fields. Besides using this annotation,
 * alphabetic constraints can be defined with, say: @Pattern(regexp = "[a-zA-Z
 * ]"). The interface is chosen simply to illustrate how to implement a
